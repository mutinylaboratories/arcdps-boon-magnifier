...
// [boon-magnifier patch] Upstream declares a custom global placement operator new here. This copy is
// compiled inside `namespace arc192` (see src/plugin/imgui192_unity.cpp), where operator new may not be
// declared, so the standard placement new from <new> is used instead.
#include <new>
